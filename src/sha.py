...
if __name__ == '__main__':
    ...
    print('SHA1 result:', sha1(b_data))

    # for "sha" verification -> d8f45903 20e1343a 915b6394 170650a8 f35d6926
    # for "Sha" verification -> ba79baeb 9f10896a 46ae7471 5271b7f5 86e74640
